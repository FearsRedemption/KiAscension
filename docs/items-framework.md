...
- `Saiyan Strike`: starter punch/kick combat item with a simple three-step combo and physical power scaling.
...
- Higher-tier weight benches, striking dummy, treadmill, meditation mat, and energy target range.
