...
| 11. Skill feel/terrain/sound/visual behavior | Partially implemented gameplay | Beams, disks, barrages, heavy blasts, terrain blocking, terrain-passing ultimates, and impact hooks exist with temporary generated effect sprites. Advanced charge/cooldown/fatigue and final per-technique art/audio remain planned. |
